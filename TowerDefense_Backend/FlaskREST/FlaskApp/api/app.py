...
class Games(db.Model):
    ...
    def __repr__(self):
        return f"Game {self.game_id}: Time: {self.play_time_minutes} min, Coins Spent: {self.coins_spent}, Max Wave: {self.max_wave_reached}, Enemies Killed: {self.enemies_killed}"
...
def add_random_game():
    ...
    db.session.commit()
    return f"Games added successfully: {new_game}"
